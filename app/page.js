    ...
    <div className="flex w-full h-[88vh] p-6">
      ...
      <div className="w-1/2 justify-center flex">
        <p className="my-4 text-base  font-medium text-gray-700 leading-relaxed tracking-wide flex flex-col justify-center px-4 py-2 bg-white ">
          ...
          entrepreneurs with state-of-the-art web solutions. At the heart of our
          service is the powerful synergy of Next.js and TailwindCSS,
          ...
          but also highly scalable and SEO-friendly. With TailwindCSS, we bring
          a level of customization and responsiveness that makes your website
          not just functionally robust but also aesthetically compelling,
          adapting flawlessly to any device or screen size.
        </p>
      </div>
    </div>
  );
